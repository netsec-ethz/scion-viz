...
var COL_HEAD = [ 'P0', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9',
		'P10', 'P11' ];
var COL_NULL = [ '-', '-', '-', '-', '-', '-', '-', '-', '-', '-' ];
...
var nullStats = [ j('', COL_HEAD), j('sent pkts', COL_NULL),
		j('recv pkts', COL_NULL), j('ack pkts', COL_NULL), j('rtts', COL_NULL),
		j('loss rates', COL_NULL), j('IF counts', COL_NULL),
		j('IF lists', COL_NULL) ]
...
$(function() {
	...
	// TODO: just change color of missing title
});
